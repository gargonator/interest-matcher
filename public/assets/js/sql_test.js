...
// var results = User.findAll().then(users => console.log(users));

// sequelize.query('SELECT * from Users WHERE id = 2', {type: sequelize.QueryTypes.SELECT}).then(row => {
// 	console.log(row);
// })

// results.then((res) => console.log(results));
